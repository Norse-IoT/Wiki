...
function updateCredits(){
    document.querySelector('footer').innerHTML = `
		<p id="social-block">
			<a target="_blank" href="https://norseiot.club"><span class="item">© ${new Date().getFullYear()} Norse IoT Club</span></a>
			 · <a class="social item" target="_blank" href="https://github.com/norse-iot"><i class="fa fa-github"></i></a>
